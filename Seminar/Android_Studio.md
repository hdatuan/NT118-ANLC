...
|---------|---------------|---------------|
| **Mục đích** | Chuyên biệt cho Android | Đa ngôn ngữ, đa nền tảng |
| **Hỗ trợ Android SDK** | Tích hợp sẵn, native | Qua plugin (hạn chế) |
| **Emulator / AVD** | Tích hợp sẵn | Không có |
| **Layout Editor** | Có (Android XML & Compose Preview) | Không có |
| **Logcat / Profiler** | Có | Không có |
| **Gradle tích hợp** | Tối ưu cho Android | Hỗ trợ chung |
| **Giá** | Miễn phí | Community (miễn phí) / Ultimate (trả phí) |

### Kết luận

- **Dùng Android Studio** khi mục tiêu là phát triển ứng dụng Android (Native).
- **Dùng IntelliJ IDEA** khi làm việc đa nền tảng (backend, multiplatform Kotlin).
- Android Studio chính là IntelliJ IDEA đã được tùy chỉnh sâu cho Android – có thêm toàn bộ công cụ Android mà IntelliJ IDEA không có.
